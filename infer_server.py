...
app = Flask('MASR', template_folder="templates", static_folder="static", static_url_path="/")
# 允许跨越访问
CORS(app)
...
predictors: List[MASRPredictor] = [predictor]
...
if __name__ == '__main__':
    ...
    for _ in range(args.num_websocket_p - 1):
        predictor1 = MASRPredictor(configs=args.configs,
                                   model_path=args.model_path,
                                   use_gpu=args.use_gpu,
                                   use_pun=args.use_pun,
                                   pun_model_dir=args.pun_model_dir)
