...
add_arg('resume_model',     str,   'models/{}/best_model/',    '准备转换的模型路径')
...
trainer.export(save_model_path=args.save_model, resume_model=args.resume_model.format(args.use_model))
